using SampleLibrary;
using SampleLibrary.Household;

namespace SampleApp.Tests;

// ROADMAP "Tooling & Test Integrity": the adversarial reverse fixture. Every reverse fixture
// before Sample.Nullability bound exactly one class per namespace, and no exported
// nullable-returning function ever threw. Sample.Household is Oreo and Mylo's house — three
...
//       -> Kotlin sample-library             HouseholdSample.kt
//         -> (reverse bridge, ADR-050/051/053) sample.household.{Cat,Toy,Household,StrayCat}
//           -> real C# SampleDependency NuGet  Sample.Household.{Cat,Toy,Household,StrayCat}
