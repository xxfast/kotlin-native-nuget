...
- **Check ROADMAP.md, `docs/backlog/`, and the archive (`docs/roadmap-archive.md`) before proposing an item**, including as a *rejected* one; settled and completed decisions live in the archive, and re-proposing one wastes the human's time.
