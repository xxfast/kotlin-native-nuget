...
//       -> Kotlin test-library             CollarSample.kt (this file)
//         -> (reverse bridge, ADR-058)       test.structs.{Extent,Collar,Collars}
//           -> real C# TestDependency NuGet Test.Structs.{Extent,Collar,Collars}
//
