using SampleLibrary.Nullability;
...
//       -> Kotlin sample-library             fun findNickname(name: String): String?
//         -> (reverse bridge, ADR-053)       sample.nullability.NicknameBook.find
//           -> real C# SampleDependency NuGet  NicknameBook.Find("Oreo")
//           <- "Biscuit" | null
//
...
//     receiver fails to compile in sample-library.
