...
- [ ] **A bare sealed-typed parameter (`fun f(shape: Shape)`), and a constructor with sealed-typed parameters, vanish from C# with no diagnostic instead of skipping named.** ([details](docs/backlog/sealed-collection-return-silently-drops.md))
